              ...
              r('div', { attrs: { id: 'view' } }, [
                r('iframe', {
                  attrs: {
                    ...
                    src: 'https://player.twitch.tv/?channel=gersogogi&parent=izjoa.github.io',
                    frameborder: '0',
      ...
      u = {
        ...
        methods: {
          createUchat() {
            ...
            /* 바꿔야 할 곳 (유저채팅방이름) */
            e.setAttribute('room', 'wizone_1201'), e.style.width = '100%', e.style.height = '100%', document.getElementById('chat').appendChild(e);
          },
          toggleSplit(e) {
            n.destroy(), n = 'low' === e ?
